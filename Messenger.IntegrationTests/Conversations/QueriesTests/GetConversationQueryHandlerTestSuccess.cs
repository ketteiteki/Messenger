...
using Messenger.BusinessLogic.Conversations.Queries;
using Messenger.Domain.Entities;
using Messenger.IntegrationTests.Abstraction;
using Messenger.IntegrationTests.Helpers;
using Xunit;

namespace Messenger.IntegrationTests.Conversations.QueriesTests;

public class GetConversationQueryHandlerTestSuccess : IntegrationTestBase, IIntegrationTest
{
	[Fact]
