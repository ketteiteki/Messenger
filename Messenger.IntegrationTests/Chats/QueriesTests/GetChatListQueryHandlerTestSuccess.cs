...
public class GetChatListQueryHandlerTestSuccess : IntegrationTestBase, IIntegrationTest
{
	[Fact]
	public async Task Test()
	{
		...
		var queryFor21th = new GetChatListQuery { RequesterId = user21th.Id};
		var queryForAlice = new GetChatListQuery { RequesterId = alice.Id};
